...
### 1. World Bank — menstrual hygiene management

Use for claims about global menstrual hygiene management, education, mobility, stigma, and the importance of access to menstrual hygiene products/facilities.

Citation text for site:

> The World Bank. *Menstrual Hygiene Management Enables Women and Girls to Reach Their Full Potential.* 2018.

URL: https://www.worldbank.org/en/news/feature/2018/05/25/menstrual-hygiene-management

### 2. Santa Clara County — Point-in-Time homelessness count

Use for Santa Clara County homelessness statistics only after matching the exact number and year to the report being cited.

Citation text for site:

> Santa Clara County Continuum of Care. *Point-in-Time Count Community Report.* 2025.
...
Use for tampon-use safety language and toxic shock syndrome risk.
